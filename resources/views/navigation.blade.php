                ...
                <ul class="c1">
                    ...
                    <li style="display: flex;">PC Component <span><svg xmlns="http://www.w3.org/2000/svg" fill="none"
                        ...
                        <ul>
                            ...
                            <li style="display: flex;margin-left: 15px;">Cooling <span><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-7">

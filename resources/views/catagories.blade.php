    ...
    <div class="images">
        <div class="box-border bg-gradient-to-r from-black p1">
           <div class="text-large box-border text-white">
               <img src="{{URL::to('/')}}/Images/white-logo.png" alt="logo images" class="t0">
...
@foreach ($data as $d)
    ...
    <div class="max-w-sm bg-zinc-200 border flex-col w-96 rounded-lg shadow op">
        <div href="#" class="items-center flex p-8">
            <img class=" rounded-md align-middle h-56 " width="400px" src="{{URL::to('/')}}/product_pic/{{$d['product_images']}}" alt="product image" />
        </div>
        <div class="px-5 pb-5">
            <a href="items">

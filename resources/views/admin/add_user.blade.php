...
@vite('resources/css/app.css')
    ...
    @section('content')
  <section class="max-w-4xl w-3/4 p-6 mx-auto rounded-md shadow-md ">
    <h1 class="text-xl font-bold capitalize ">Update User</h1>
    <form action="register-action" method="post" enctype="multipart/form-data">
      @csrf
        <div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
            <div>
                <label class="" for="username">fullname</label>
                <input id="username" type="text" name="fn" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border rounded-md   dark:border-gray-600 focus:border-blue-500  focus:outline-none focus:ring focus:ring-blue-500">
            ...
            <div>
                ...
                <input id="password" type="password" name="pwd" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md   dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring focus:ring-blue-500">
                <span style="color:red">
            @error('pwd')
                {{ $message }}
            @enderror
            ...
            <div>
              ...
              <div class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-zinc-600 border-dashed rounded-md  ">
                <div class="space-y-1 text-center ">
                    <svg class="mx-auto h-12 w-12 text-zinc-700" stroke="currentColor" fill="none" viewBox="0 0 48 48" aria-hidden="true">
                    ...
                    <label for="file-upload" class="relative cursor-pointer bg-white rounded-md font-medium text-zinc-600 hover:text-zinc-500 focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-blue-500">
                      <span class="text-zinc-700">Upload a file</span>
                      <input id="file-upload" name="pic" name="file-upload" type="file" class="sr-only">
                    </label>
                    <p class="pl-1 text-zinc-700">or drag and drop</p>
                  </div>
        ...
        <div class="flex justify-end mt-6">
            <button type="submit" class="px-6 py-2 leading-5 text-white transition-colors duration-200 transform bg-blue-800 rounded-md hover:bg-blue-700 focus:outline-none focus:bg-gray-600">Update account</button>
        </div>
    </form>
</section>

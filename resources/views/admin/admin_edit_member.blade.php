    ...
    <form action="register-action" method="post" enctype="multipart/form-data">
      @csrf
        ...
        <div class="flex justify-end mt-6">
            <button type="submit" class="px-6 py-2 leading-5 text-white transition-colors duration-200 transform bg-blue-800 rounded-md hover:bg-blue-700 focus:outline-none focus:bg-gray-600">Add Member</button>
        </div>
    </form>
</section>

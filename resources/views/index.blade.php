...
@foreach ($data as $d)
    ...
    <div class="max-w-sm bg-zinc-700 border flex-col w-96 border-gray-200 rounded-lg shadow  dark:border-gray-700 op">
        ...
        <div class="px-5 pb-5">
            <a href="#">
                <h5 class="text-xl font-semibold tracking-tight text-gray-900 dark:text-white">{{$d['product_name']}}</h5>
            </a>
                <p class="font-semibold tracking-tight text-gray-900 dark:text-red-800">Remening only {{$d['product_quantity']}} items</p>
